...
int main(int argc, char *argv[]) {
    ...
    historic_min = lowest_temperature(array);

    printf("\nLa menor temperatura histórica registrada es %d grados\n",historic_min);

    max_temp_per_year(array,maxs_temps);

    dump_max_temp(maxs_temps);

    max_rainfall_month_by_year(array, rainmonths);

    dump_rain(rainmonths);
